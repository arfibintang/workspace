if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
        ...
        function addDragableMarker(map, behavior) {
            ...
            //listen to the drag event and move the possition of the marker
            // as neccessary
            ...
            //re-enable the default draggability of underlying map
        ...
        function onError(error) {
            alert('cant\'t reach the remote server' + error);
        }
